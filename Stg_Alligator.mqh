...
INPUT int Alligator_SignalBaseMethod = 19;                  // Signal base method (-63-63)
...
class Stg_Alligator : public Strategy {
 public:
  ...
  static Stg_Alligator *Init(ENUM_TIMEFRAMES _tf = NULL, long _magic_no = NULL, ENUM_LOG_LEVEL _log_level = V_INFO) {
    ...
    sparams.SetSignals(_params.Alligator_SignalBaseMethod, _params.Alligator_SignalOpenMethod1,
                       _params.Alligator_SignalOpenMethod2, _params.Alligator_SignalCloseMethod1,
                       _params.Alligator_SignalCloseMethod2, _params.Alligator_SignalOpenLevel,
                       _params.Alligator_SignalCloseLevel);
  ...
  bool SignalOpen(ENUM_ORDER_TYPE _cmd, long _signal_method = EMPTY, double _signal_level = EMPTY) {
    ...
    switch (_cmd) {
      case ORDER_TYPE_BUY:
        _result = (alligator_0_lips > alligator_0_teeth + gap &&  // Check if Lips are above Teeth ...
                   alligator_0_teeth > alligator_0_jaw + gap      // ... Teeth are above Jaw ...
        );
        if (_signal_method != 0) {
          if (METHOD(_signal_method, 0))
          ...
          if (METHOD(_signal_method, 3))
            _result &= alligator_0_lips - alligator_0_teeth > alligator_0_teeth - alligator_0_jaw;
      ...
      case ORDER_TYPE_SELL:
        _result = (alligator_0_lips + gap < alligator_0_teeth &&  // Check if Lips are below Teeth and ...
        ...
        if (_signal_method != 0) {
          ...
          if (METHOD(_signal_method, 3))
            _result &= alligator_0_teeth - alligator_0_lips > alligator_0_jaw - alligator_0_teeth;
          if (METHOD(_signal_method, 4))
