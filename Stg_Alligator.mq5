...
// Inputs.
INPUT_GROUP("Alligator strategy: main");
...
// Includes strategy.
#include "Stg_Alligator.mqh"

// Defines.
#define ea_name "Strategy Alligator"
#define ea_version "1.010"
#define ea_desc "Strategy based on EA31337 framework."
#define ea_link "https://github.com/EA31337/Strategy-Alligator"
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_Alligator>(Active_Tfs);
